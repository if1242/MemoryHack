...
В папке <a href="https://github.com/if1242/MemoryHack/tree/master/classificator/tf_files"><i>tf_files</i></a> мы разместили наш датасет (на github Вы видите только по одному примеру изображения из каждого класса). 
...
Ссылка на dropbox -выгруженные фото с источников (на что хватило лимита загрузки и скорости :))
https://yadi.sk/d/9iTjanx58h9kVQ
