...
def user_input():
    ...
    if object_check['config_file'] != '':
        ...
        args.limit = 100  # Максимальное количество картинок
        args.search = 'Участники ВОВ'  # Запрос для поиска
        args.download = True  # Скачать: True/False
        args.chromedriver = 'chromedriver' # Путь к драйверу
