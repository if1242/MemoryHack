...
# извлекаем только имена файлов с расширениями "jpg", "jpeg", "png", "gif"
img_files = []
for name_file in files:
    if ".jpg" in name_file or ".jpeg" in name_file or ".png" in name_file or ".gif" in name_file:
...
for img_name in img_files:
    ...
    if result_classif == "peoplewow":
        ...
        shutil.copy(DIRECTORY_IMAGE + "/" + file_name + ".json", DIRECTORY_IMAGE + "/" + directory_for_filter[0]
                    + "/" + str(counter_people_wow) + ".json")
        ...
        shutil.copy(DIRECTORY_IMAGE + "/" + file_name + ".json", DIRECTORY_IMAGE + "/" + directory_for_filter[1]
                    + "/" + str(counter_trash_wow) + ".json")
        ...
        shutil.copy(DIRECTORY_IMAGE + "/" + file_name + ".json", DIRECTORY_IMAGE + "/" + directory_for_filter[2]
                    + "/" + str(counter_dont_know_wow) + ".json")
